...
const config = {
  ...
  site_name: 'Isometric Interiors',

  // Your website's description, used for favicon meta tags
  site_description: 'Isometric Interiors provide complete interior solutions for home and offices',

  // Your website's URL, used for sitemap
  site_url: 'https://www.isometricinteriors.com',

  // Google Analytics tracking ID (leave blank to disable)
  googleAnalyticsUA: 'TEST',
